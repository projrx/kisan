...
<?php 
  ...
  ?>
	...
	<!-- Document Title
	============================================= -->
	<title>Party Funds Forms | APKI </title>
...
<?php if(!empty($_GET['id'])){ ?>
  ...
  <div class="container">
   ...
   <?php
      ...
      $rows =mysqli_query($con,"SELECT * FROM party where id=$id " ) or die(mysqli_error($con));
